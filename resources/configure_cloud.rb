...
attribute :management_server_port, :kind_of => Integer, :default => 8080
attribute :admin_apikey, :kind_of => String
attribute :admin_secretkey, :kind_of => String
attribute :database_ip, :kind_of => String, :default => '127.0.0.1'
attribute :database_port, :kind_of => Integer, :default => 3306
